...
char *strupr(char *str){
                ...
                case TOKEN_TYPE_SETPRIORITY:
					...
					switch ( g_Lexer.CurrToken )
					{
						...
						case TOKEN_TYPE_IDENT:
							...
							if ( strcasecmp ( g_Lexer.pstrCurrLexeme, PRIORITY_LOW_KEYWORD ) == 0 )
								g_ScriptHeader.iPriorityType = PRIORITY_LOW;
							else if ( strcasecmp ( g_Lexer.pstrCurrLexeme, PRIORITY_MED_KEYWORD ) == 0 )
								g_ScriptHeader.iPriorityType = PRIORITY_MED;
							else if ( strcasecmp ( g_Lexer.pstrCurrLexeme, PRIORITY_HIGH_KEYWORD ) == 0 )
    ...
    */
    ...
    void ExitOnCodeError ( char * pstrErrorMssg )
    {
        ...
        printf ( "Could not assemble %s.", g_pstrExecFilename );
